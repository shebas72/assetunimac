...
while($row1 = $final1->fetch_assoc()) {
 ...
 <a href=\"assetdel.php?del=" . $row1["id"] . "\" class=\"btn btn-danger btn-lg waves-effect waves-light m-1\">DELETE</a>
<a href=\"assetedit.php?edit=" . $row1["id"] . "\" class=\"btn btn-primary btn-lg waves-effect waves-light m-1\">EDIT</a>
