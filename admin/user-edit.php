...
$file_loc = $_FILES['usrimg']['tmp_name'];
 ...
 $query=mysqli_query($con, "update admin set fname='$fname',lname='$lname',title='$title',email='$email',password='$password',unid='$unid',phone='$phone',roles='$roles',usrimg='$usrimg' where id='$id'");
