...
if (isset($_POST["upload"])) {
    ...
    $fileName = $_FILES["brandfile"]["tmp_name"];
    
    if ($_FILES["brandfile"]["size"] > 0) {
        
        $brandfile = fopen($fileName, "r");
        
        while (($column = fgetcsv($brandfile, 10000, ",")) !== FALSE) {
            $sqlInsert = "INSERT into brand (brand)
                   values ('" . $column[0] . "')";
    ...
    <?php } ?>
          ...
          <form action="" method="post" enctype="multipart/form-data">
           <div class="form-group row">
            ...
            <div class="col-sm-10">
            <input type="file" class="form-control" id="site" name="brandfile" placeholder="Enter Name" required>
            </div>
