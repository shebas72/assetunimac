...
if(isset($_POST['submit']))
 ...
 $new_name = $target.time()."-".rand(1000, 9999)."-".$propic;
    ...
    $test = mysqli_query($con,"SELECT * FROM asset WHERE asid='$asid'");
     ...
     $query=mysqli_query($con, "insert into asset (asid, cost, description, pno, pdate, model, status, sno, site, category, location, department, employee, brand, uid, cond, propic) value ('$asid', '$cost', '$description', '$pno', '$pdate', '$model', '$status', '$sno', '$site', '$category', '$location',         '$department', '$employee', '$brand', '$uid', '$cond', '$propic' )");
...
?>
 ...
 <div class="col-lg-2">
        ...
        <p>&nbsp;</p>
           ...
           <div class="col-lg-4">
        <img class="mr-3 rounded-circle" id="blah1" src="http://placehold.it/180" alt="your image" width="180" height="180" />
        <p>&nbsp;</p>
      </div>
        ...
        <div class="input-group mb-3">
                <label for="input-22" class="col-sm-2 col-form-label">Image</label>
                  <div class="custom-file col-sm-4">
                   <input onchange="readURL(this);" type="file" name="propic" class="custom-file-input" id="inputGroupFile01">
 ...
 <div class="form-group row">
        <div class="input-group mb-3">
                <label for="input-22" class="col-sm-2 col-form-label">Image</label>
                  <div class="custom-file col-sm-4">
                   <input onchange="readURL1(this);" type="file" name="propic1" class="custom-file-input" id="inputGroupFile01">
                    <label class="custom-file-label" for="inputGroupFile01">Choose file</label>
                  </div>
                </div>
              </div>
